...
`;var k=l(1262);const C=e=>{let{}=e;const[t,l]=(0,o.useState)(0),a=(0,o.useRef)(null),r=(0,o.useMemo)((()=>d.map((e=>({key:e.level,children:o.createElement(c.df,{as:"card",className:"py-4"},o.createElement(m,{rules:e.rule,levelName:`LV ${e.level}`,totalAmount:e.totalAmount,isActive:t===Number(e.level)}))})))),[t]),n=(0,o.useMemo)((()=>o.createElement(s.kC,{horizontal:s.cv.center},o.createElement(y,null,o.createElement("select",{title:"level",value:t,onChange:e=>p(Number(e.target.value))},u?.map((e=>o.createElement("option",{value:e.value},e.text))))))),[t]),p=e=>{l(e),a.current?.slideToActualIndex(e)};return o.createElement(Z,null,o.createElement(s.tC,{gridTheme:i.Z},n,o.createElement(k.Z,null,(()=>o.createElement(c.ZP,{controllerRef:a,isEnableLoop:!1,isCenteredSlides:!0,isEnableNavButton:!0,slidesPerView:1,spaceBetween:20,staticHeight:"270px",data:r,isSlideItemMemo:!0,breakpoints:{576:{slidesPerView:"auto"}}})))))},y=n.ZP.div`
  color: #737b8c;
  padding: 10px 0;
`,Z=n.ZP.div`
