...
`;var E=l(1262);const C=()=>{const[e,t]=(0,o.useState)(0),[l,a]=(0,o.useState)(),r=(0,o.useMemo)((()=>d.map((t=>({key:t.level,children:o.createElement(c.B2,{className:"py-4"},o.createElement(m,{rules:t.rule,levelName:`LV ${t.level}`,totalAmount:t.totalAmount,isActive:e===Number(t.level)}))})))),[e]),i=(0,o.useMemo)((()=>o.createElement(s.kC,{horizontal:s.cv.center},o.createElement(y,null,o.createElement("select",{title:"level",value:e,onChange:e=>u(Number(e.target.value))},p?.map((e=>o.createElement("option",{value:e.value},e.text))))))),[e]),u=e=>{t(e),l?.slideToSourceIndex(e)};return o.createElement(Z,null,o.createElement(s.tC,{gridTheme:n.Z},i,o.createElement(E.Z,null,(()=>o.createElement(c.ZP,{setController:a,isEnableLoop:!1,isCenteredSlides:!0,isEnableNavButton:!0,slidesPerView:1,spaceBetween:20,height:"270px",data:r,isSlideItemMemo:!0,breakpoints:{576:{slidesPerView:"auto"}}})))))},y=i.ZP.div`
  color: #737b8c;
  padding: 10px 0;
`,Z=i.ZP.div`
